...
void main() {
  ...
  testWidgets("Custom debugFillProperties", (WidgetTester tester) async {
    ...
    expect(
      description[4].contains("unselectedIconTheme: IconThemeData"),
      isTrue,
    );
    expect(
      description[4].contains("(color: ${const Color(0x00000097)})"),
      isTrue,
    );
    expect(description[5].contains("selectedIconTheme: IconThemeData"), isTrue);
    expect(
      description[5].contains("(color: ${const Color(0x00000098)})"),
      isTrue,
    );
